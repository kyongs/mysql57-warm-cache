...
enum monitor_id_t {
    ...
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_STORED_STK,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_STORED_OL,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_STORED_CUST,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_READ_STK,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_READ_OL,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_READ_CUST,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_WRITTEN_STK,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_WRITTEN_OL,
    MONITOR_OVLD_SRV_WARM_BUF_PAGES_WRITTEN_CUST,
	MONITOR_OVLD_SRV_MOVE_TO_WARM_BUF_CNT_STK,
    MONITOR_OVLD_SRV_MOVE_TO_WARM_BUF_CNT_OL,
    MONITOR_OVLD_SRV_MOVE_TO_WARM_BUF_CNT_CUST,
	MONITOR_OVLD_SRV_STAY_IN_BUF_CNT_STK,
    MONITOR_OVLD_SRV_STAY_IN_BUF_CNT_OL,
    MONITOR_OVLD_SRV_STAY_IN_BUF_CNT_CUST,
	MONITOR_OVLD_SRV_WARM_BUF_PAGES_WRITTEN_CP,
	MONITOR_OVLD_SRV_WARM_BUF_PAGES_WRITTEN_LRU,
